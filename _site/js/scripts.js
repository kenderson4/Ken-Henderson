(function ($) {
    ...
    $(document).on('click', "a.more", function() {
      ...
      $(this).parent().find(".elips").toggle();
      $(this).parent().parent(".skill").find(".more_section").slideToggle("fast");
    });
    
    $("div.skill p").each(function() {
      $(this).html($(this).html().substring(0,200)+'<span class="elips">...</span><span class="more_section">'+$(this).html().substring(200)+'</span> <a href="javascript:void(0);" class="more">Show <span>More</span><span style="display:none;">Less</span></a>');
      $(this).find(".more_section").hide();
    });
...
function initialize() {
    ...
    var myLatlng = new google.maps.LatLng(37.452616, -77.676077);
    var mapOptions = {
        zoom: 10,
        scrollwheel: false,
    ...
    var contentString = '<div id="content">' +
        '<div id="siteNotice">' +
        '</div>' +
        '<h3 id="firstHeading" class="firstHeading">Ken Henderson</h3>' +
        '<div id="bodyContent">' +
        '<p>2312 Millcrest Ter' +
        'Midlothian, VA 23112, USA. </p>' +
        '</div>' +
        '</div>';
